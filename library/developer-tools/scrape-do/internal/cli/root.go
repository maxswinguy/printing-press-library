...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/scrape-do/internal/client"
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "scrape-do-pp-cli",
		Short: `The first CLI for Scrape-do with Google SERP scraping plus a credit and concurrency governor`,
		Long: `The first CLI for Scrape-do with Google SERP scraping plus a credit and concurrency governor
...
Health check: run 'scrape-do-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("scrape-do-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'scrape-do-pp-cli profile list')")
	...
	rootCmd.AddCommand(newScrapeCmd(flags))
	rootCmd.AddCommand(newGoogleCmd(flags))
	rootCmd.AddCommand(newSQLCmd(flags))
	rootCmd.AddCommand(newNovelBatchCmd(flags))
	rootCmd.AddCommand(newNovelBudgetCmd(flags))
	rootCmd.AddCommand(newNovelCostCmd(flags))
	rootCmd.AddCommand(newNovelDriftCmd(flags))
	rootCmd.AddCommand(newNovelMoversCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "version",
		Short: "Print the scrape-do-pp-cli version string",
