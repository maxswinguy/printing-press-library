...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/media-and-entertainment/ticketdata/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("TICKETDATA_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "ticketdata-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
