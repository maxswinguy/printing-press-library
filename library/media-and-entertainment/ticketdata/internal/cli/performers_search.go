...
func newPerformersSearchCmd(flags *rootFlags) *cobra.Command {
	var flagQ string
	...
	cmd.Flags().StringVar(&flagQ, "query", "", "Performer name to search for (e.g. 'ariana grande')")
	cmd.Flags().StringVar(&flagQ, "q", "", "Performer name to search for (e.g. 'ariana grande')")
