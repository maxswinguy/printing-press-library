...
func newVenuesSearchCmd(flags *rootFlags) *cobra.Command {
	var flagQ string
	...
	cmd.Flags().StringVar(&flagQ, "query", "", "Venue name to search for (e.g. 'state farm arena')")
	cmd.Flags().StringVar(&flagQ, "q", "", "Venue name to search for (e.g. 'state farm arena')")
