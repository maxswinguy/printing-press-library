...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "substack-reader-pp-cli",
		Short: `Substack CLI — Read any Substack publication as a local, full-text-searchable corpus — keyless for free posts, your own session for wh…`,
		Long: `Substack CLI — Read any Substack publication as a local, full-text-searchable corpus — keyless for free posts, your own session for wh…
...
Health check: run 'substack-reader-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("substack-reader-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'substack-reader-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelArchiveCmd(flags))
	rootCmd.AddCommand(newNovelAuthorCompareCmd(flags))
	rootCmd.AddCommand(newNovelDigestCmd(flags))
	rootCmd.AddCommand(newNovelReadCmd(flags))
